...
const RecentUpdates = (props) =>{
    ...
    <div className="flex items-center py-2 bg-gray-50 rounded-md dsfadfasfas:bg-gray-700 w-full">
        <textarea style={{resize: "none"}} id="chat" rows="1" className="block rounded-md p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dsfadfasfas:bg-gray-800 dsfadfasfas:border-gray-600 dsfadfasfas:placeholder-gray-400 dsfadfasfas:text-white dsfadfasfas:focus:ring-blue-500 dsfadfasfas:focus:border-blue-500" placeholder="Create Post"></textarea>
        <button type="button" className="inline-flex justify-center p-1 text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 dsfadfasfas:text-gray-400 dsfadfasfas:hover:text-white dsfadfasfas:hover:bg-gray-600">
        ...
        <button type="button" className="p-1 text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 dsfadfasfas:text-gray-400 dsfadfasfas:hover:text-white dsfadfasfas:hover:bg-gray-600">
